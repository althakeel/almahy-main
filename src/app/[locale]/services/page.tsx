  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 py-20 px-4 md:px-8">
      <div className="max-w-[1200px] mx-auto">
        ...
        {/* CTA Section */}
        <div className="mt-16 text-center bg-gradient-to-r from-amber-500 to-yellow-400 rounded-2xl p-12 shadow-2xl">
          ...
          <Link 
            ...
            className="inline-block bg-gray-900 hover:bg-amber-500 text-white font-bold px-8 py-4 rounded-full text-lg transition-colors shadow-lg border-2 border-amber-400"
          >
            {t.contactButton}
          </Link>
        </div>
