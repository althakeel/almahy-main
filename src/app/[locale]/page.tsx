...
export default function Home() {
  ...
  useEffect(() => {
    const lines = heroHeadlines[headlineIdx];
  ...
  }, [charIndex, lineIndex, headlineIdx]);
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"} lang={lang} className="w-full">
      ...
      <section
        className="relative w-full h-[53vh] min-h-[500px] md:min-h-[400px] max-h-[900px] bg-cover bg-center bg-no-repeat flex items-center"
        style={{
      ...
      >
        ...
        <div className="relative z-10 flex items-center px-6 md:px-20 w-full">
          ...
          <div className="flex-1 flex flex-col justify-center items-start text-left max-w-7xl w-full md:ml-6 ml-0" style={{gap: '5px'}}>
            ...
            <h1 className="text-3xl md:text-5xl font-serif font-bold text-white mt-4 whitespace-pre-line min-h-[150px]">
              {displayText}
            </h1>

            <div className="flex flex-row items-center mb-6 md:mb-8 w-full">
